...
<body class="bg-light">
  <div class="container py-5">
    ...
    <form method="POST" action="" class="bg-white p-4 rounded shadow-sm">
      <div class="mb-3">
        <label for="first_name" class="form-label">Student ID</label>
      ...
      <div class="mb-3">
        ...
        <input type="text" name="student_email" value="<?php echo $student_data['student_email']?>"id="student_email" class="form-control" placeholder="Enter your new student email" required>
      </div>
      <div class="mb-3">
